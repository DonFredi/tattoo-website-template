      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center max-w-[1400px] mx-auto">
        ...
        >
          ...
          <p className="font-sans text-[15px] leading-[1.85] text-ash mb-4 font-light">
            Trained in classical illustration before ever picking up a machine, I approach every piece as
            a translation problem: how do we render the ineffable — a memory, a grief, a becoming —
            in permanent lines on living skin?
          </p>
          <p className="font-sans text-[15px] leading-[1.85] text-ash font-light">
            My studio in East London is appointment-only. I take on a limited number of clients each
            month, not because I'm precious about it, but because this kind of work demands full
            presence and no shortcuts.
          </p>
          <div className="w-12 h-px bg-ember my-9" />
          <p className="font-display text-[32px] font-light italic text-gold/70">
            Elara Nova
          </p>
        </motion.div>
      </div>
