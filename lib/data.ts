...
export const GALLERY_ITEMS = [
  { title: 'The Thistle & Moon',  tag: 'Fine Line · Botanical',    layout: 'tall-left'   },
  { title: 'Sacred Geometry',     tag: 'Geometric · Blackwork',    layout: 'mid-center'  },
  { title: 'The Moth Study',      tag: 'Illustrative · Fine Line', layout: 'square-right' },
  { title: 'Compass Rose',        tag: 'Minimalist · Blackwork',   layout: 'square-left'  },
  { title: 'Wave Study III',      tag: 'Fine Line · Abstract',     layout: 'wide-center'  },
  { title: 'The Heart, Exposed',  tag: 'Illustrative · Anatomical',layout: 'tall-right'   },
] as const

export const MARQUEE_ITEMS = [
  'Fine Line', 'Blackwork', 'Neo-Traditional', 'Botanical',
  'Geometric', 'Portraiture', 'Illustrative', 'Minimalist', 'Custom Design',
] as const
